<template>
    <div id="homeComponent" :class="{ fadeBG: viewForm === true || editForm === true }"
        @click.prevent="viewForm = false; editForm = false">
        <div id="addCar">
            <button class="addCarBtn" @click.prevent.stop="showCarForm">Add Car</button>
        </div>
        <div id="carComponent">
            <GalleryCard :cars="cars" @alertPrice="displayPrice" @isEdit="editCarForm" @editableCar="editCarData"
                @deleteCar="removeCar" />
        </div>
    </div>
