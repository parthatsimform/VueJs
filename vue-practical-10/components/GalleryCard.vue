        ...
        <div class="cardHeader">
            <Transition name="edit">
                <div class="editBtnDiv">
                    <button class="editBtn" @click.prevent.stop="carStore.editFormOpen(props.car)" title="Edit">
            ...
            <div class="deleteBtnDiv">
                <button class="deleteBtn" @click.prevent.stop="carStore.removeCar(props.car)" title="Delete">
